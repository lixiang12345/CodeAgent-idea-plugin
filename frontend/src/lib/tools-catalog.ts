...
export const TOOL_CATALOG: ToolCatalogEntry[] = [
  ...
  { id: "conversation-retrieval", name: "CodeAgent Context Engine", icon: "augment-logo", desc: "\u540c\u4e00\u7ec4\u4ef6\uff0c\u526f\u6807\u9898 Retrieving from: Conversations", secondary: "Retrieving from: Conversations", pluginTool: null, connected: false },
  ...
  { id: "remove-files", name: "Remove", icon: "file-minus", desc: "\u5220\u9664\u6587\u4ef6", secondary: undefined, pluginTool: null, connected: false },
  { id: "apply-patch", name: "Apply Patch", icon: "file-diff", desc: "\u5e94\u7528\u591a\u6587\u4ef6\u8865\u4e01", secondary: undefined, pluginTool: null, connected: false },
  ...
  { id: "web-fetch", name: "Web Fetch", icon: "globe", desc: "\u6293\u53d6 URL", secondary: undefined, pluginTool: null, connected: false },
  { id: "web", name: "Web", icon: "globe", desc: "\u7f51\u9875\u641c\u7d22", secondary: undefined, pluginTool: null, connected: false },
  { id: "open-browser", name: "Open in Browser", icon: "external-link", desc: "\u6d4f\u89c8\u5668\u6253\u5f00", secondary: undefined, pluginTool: null, connected: false },
  ...
  { id: "ask-user", name: "Ask User", icon: "message-circle", desc: "\u5411\u7528\u6237\u63d0\u95ee", secondary: undefined, pluginTool: null, connected: false },
