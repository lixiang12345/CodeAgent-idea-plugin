...
export const TOOL_CATALOG: ToolCatalogEntry[] = [
  ...
  { id: "web", name: "Web", icon: "globe", desc: "\u7f51\u9875\u641c\u7d22", secondary: undefined, pluginTool: "web_search", connected: false },
  ...
  { id: "subagent", name: "SubAgent", icon: "bot", desc: "\u5b50\u4ee3\u7406", secondary: undefined, pluginTool: "subagent", connected: false },
  ...
  { id: "github", name: "GitHub", icon: "github", desc: "GitHub \u96c6\u6210", secondary: undefined, pluginTool: "github_search", connected: false },
  { id: "linear", name: "Linear", icon: "linear", desc: "Linear", secondary: undefined, pluginTool: "linear_search", connected: false },
  { id: "notion", name: "Notion", icon: "notion", desc: "Notion", secondary: undefined, pluginTool: "notion_search", connected: false },
  { id: "jira", name: "Jira", icon: "jira", desc: "Jira", secondary: undefined, pluginTool: "jira_search", connected: false },
  { id: "confluence", name: "Confluence", icon: "confluence", desc: "Confluence", secondary: undefined, pluginTool: "confluence_search", connected: false },
  { id: "glean", name: "Glean", icon: "glean", desc: "Glean", secondary: undefined, pluginTool: "glean_search", connected: false },
  { id: "supabase", name: "Supabase", icon: "supabase", desc: "Supabase", secondary: undefined, pluginTool: "supabase_query", connected: false },
